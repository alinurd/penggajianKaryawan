            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/mimbar.jpg" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">MIMBAR UTINA</div>
                           <div class="bio">Seorang Mahasiswa Informatika</div>
                           <div class="Job">Universitas Pamulang</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Skripsi &copy; MIMBAR UTINA | Aplikasi Penggajian 2024 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
