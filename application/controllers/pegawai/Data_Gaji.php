...
// data_jabatan.tj_transport,data_jabatan.uang_makan,data_kehadiran.alpha,data_kehadiran.lembur,data_kehadiran.telat,data_kehadiran.hadir,data_kehadiran.bulan	 FROM data_pegawai
