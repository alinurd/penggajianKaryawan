	...
	<table class="table table-bordered table-striped">
		...
		<?php $no=1; foreach($input_absensi as $a) :?>
			<tr>
				...
				<td class="text-center text-info"><strong><?php echo $a->hadir?></strong></td>
				<!-- <td><input type="text" name="hadir[]" class="form-control disabled" value="<?=$a->hadir?>"></td> -->
				<td><input type="number" name="sakit[]" class="form-control" value="<?=$a->sakit?>"></td>
				<td><input type="number" name="alpha[]" class="form-control" value="<?=$a->alpha?>"></td>
		<?php endforeach; ?>
	</table><br></br><br></br>
	</form>
